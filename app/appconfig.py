...
REPOSITORIES = [
    (
        ...
        "mingw-w64-",
        REPO_URL + "/mingw/ucrt64",
        DOWNLOAD_URL + "/mingw/ucrt64",
    ...
    (
        ...
        "mingw-w64-",
        REPO_URL + "/mingw/clang64",
        DOWNLOAD_URL + "/mingw/clang64",
        "https://github.com/msys2/MINGW-packages",
    ),
    (
        "clangarm64",
        ...
        "mingw-w64-",
        REPO_URL + "/mingw/clangarm64",
        DOWNLOAD_URL + "/mingw/clangarm64",
        "https://github.com/msys2/MINGW-packages",
    ),
    (
        "msys",
        ...
        "",
        "",
        REPO_URL + "/msys/x86_64",
        DOWNLOAD_URL + "/msys/x86_64",
    ...
    (
        ...
        "mingw-w64-x86_64-",
        "mingw-w64-",
        REPO_URL + "/mingw/mingw64",
        DOWNLOAD_URL + "/mingw/mingw64",
        "https://github.com/msys2/MINGW-packages",
    ),
    (
        "mingw32",
        ...
        "mingw-w64-i686-",
        "mingw-w64-",
        REPO_URL + "/mingw/mingw32",
        DOWNLOAD_URL + "/mingw/mingw32",
        "https://github.com/msys2/MINGW-packages",
    ),
]
